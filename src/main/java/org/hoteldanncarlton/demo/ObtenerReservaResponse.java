 ...
 *                             &lt;element name="titular" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
public class ObtenerReservaResponse {
    ...
    protected ObtenerReservaResponse.Residentes residentes;
     ...
     * @return
     *     possible object is
     *     {@link ObtenerReservaResponse.Residentes }
     *     
     */
    public ObtenerReservaResponse.Residentes getResidentes() {
        return residentes;
    }
     ...
     *     
     */
    public void setResidentes(ObtenerReservaResponse.Residentes value) {
    ...
    public static class Residentes {
        ...
        protected List<ObtenerReservaResponse.Residentes.Persona> persona;
         ...
         * {@link ObtenerReservaResponse.Residentes.Persona }
         * 
         * 
         */
        public List<ObtenerReservaResponse.Residentes.Persona> getPersona() {
            if (persona == null) {
                persona = new ArrayList<ObtenerReservaResponse.Residentes.Persona>();
            }
            return this.persona;
        }
